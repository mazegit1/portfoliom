...
const Home = () => {
  ...
  return (
    <div className="hero text-black">
        ...
        <div className="bottom flex flex-col sm:flex-row items-center justify-center gap-10 px-8 sm:px-16 lg:px-56">
          ...
          >
            ...
            <button
              ...
              className="text-lg sm:text-xl flex items-center gap-2 text-gray-700 hover:text-blue-600 transition duration-300 mt-4"
            >
      ...
      {/* Next Section (where you want to scroll to) */}
      <div id="nextSection" className="pt-48">
        {/* Add content for the next section here */}
      </div>
    </div>
  );
};
